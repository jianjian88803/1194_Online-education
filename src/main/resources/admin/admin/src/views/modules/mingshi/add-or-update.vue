<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="讲师工号" prop="jiangshigonghao">
          <el-input v-model="ruleForm.jiangshigonghao" 
              placeholder="讲师工号" clearable  :readonly="ro.jiangshigonghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="讲师工号" prop="jiangshigonghao">
              <el-input v-model="ruleForm.jiangshigonghao" 
                placeholder="讲师工号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="讲师姓名" prop="jiangshixingming">
          <el-input v-model="ruleForm.jiangshixingming" 
              placeholder="讲师姓名" clearable  :readonly="ro.jiangshixingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="讲师姓名" prop="jiangshixingming">
              <el-input v-model="ruleForm.jiangshixingming" 
                placeholder="讲师姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所属单位" prop="suoshudanwei">
          <el-input v-model="ruleForm.suoshudanwei" 
              placeholder="所属单位" clearable  :readonly="ro.suoshudanwei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所属单位" prop="suoshudanwei">
              <el-input v-model="ruleForm.suoshudanwei" 
                placeholder="所属单位" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="教授课程" prop="jiaoshoukecheng">
          <el-input v-model="ruleForm.jiaoshoukecheng" 
              placeholder="教授课程" clearable  :readonly="ro.jiaoshoukecheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="教授课程" prop="jiaoshoukecheng">
              <el-input v-model="ruleForm.jiaoshoukecheng" 
                placeholder="教授课程" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="获奖证书" prop="huojiangzhengshu">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.huojiangzhengshu" label="获奖证书" prop="huojiangzhengshu">
                    <span>{{ruleForm.huojiangzhengshu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	jiangshigonghao : false,
	jiangshixingming : false,
	xingbie : false,
	touxiang : false,
	huojiangzhengshu : false,
	suoshudanwei : false,
	jiaoshoukecheng : false,
	xiangxixinxi : false,
	clicktime : false,
      },
      ruleForm: {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='jiangshigonghao'){
            this.ruleForm.jiangshigonghao = obj[o];
	    this.ro.jiangshigonghao = true;
            continue;
          }
          if(o=='jiangshixingming'){
            this.ruleForm.jiangshixingming = obj[o];
	    this.ro.jiangshixingming = true;
            continue;
          }
          if(o=='xingbie'){
	    ...
	    this.ro.huojiangzhengshu = true;
          ...
          if(o=='suoshudanwei'){
            this.ruleForm.suoshudanwei = obj[o];
	    this.ro.suoshudanwei = true;
            continue;
          }
          if(o=='jiaoshoukecheng'){
            this.ruleForm.jiaoshoukecheng = obj[o];
	    this.ro.jiaoshoukecheng = true;
            continue;
          }
          if(o=='xiangxixinxi'){
	...
	this.ruleForm.xiangxixinxi = this.ruleForm.xiangxixinxi.replace(reg,'../../../springboot8525u/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `mingshi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.mingshiCrossAddOrUpdateFlag = false;
                  this.parent.search();
