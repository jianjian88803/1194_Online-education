<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="课程账号" prop="kechengzhanghao">
          <el-input v-model="ruleForm.kechengzhanghao" 
              placeholder="课程账号" clearable  :readonly="ro.kechengzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="课程账号" prop="kechengzhanghao">
              <el-input v-model="ruleForm.kechengzhanghao" 
                placeholder="课程账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="课程姓名" prop="kechengxingming">
          <el-input v-model="ruleForm.kechengxingming" 
              placeholder="课程姓名" clearable  :readonly="ro.kechengxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="课程姓名" prop="kechengxingming">
              <el-input v-model="ruleForm.kechengxingming" 
                placeholder="课程姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	kechengzhanghao : false,
	mima : false,
	kechengxingming : false,
	xingbie : false,
	shouji : false,
	youxiang : false,
	zhaopian : false,
	money : false,
      ...
      rules: {
          kechengzhanghao: [
                { required: true, message: '课程账号不能为空', trigger: 'blur' },
          ],
          mima: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='kechengzhanghao'){
            this.ruleForm.kechengzhanghao = obj[o];
	    this.ro.kechengzhanghao = true;
            continue;
          }
          if(o=='mima'){
	    ...
	    this.ro.mima = true;
          ...
          if(o=='kechengxingming'){
            this.ruleForm.kechengxingming = obj[o];
	    this.ro.kechengxingming = true;
            continue;
          }
          if(o=='xingbie'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `kechengguanliyuan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.kechengguanliyuanCrossAddOrUpdateFlag = false;
                  this.parent.search();
