<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="普通账号" prop="putongzhanghao">
          <el-input v-model="ruleForm.putongzhanghao" 
              placeholder="普通账号" clearable  :readonly="ro.putongzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="普通账号" prop="putongzhanghao">
              <el-input v-model="ruleForm.putongzhanghao" 
                placeholder="普通账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="普通姓名" prop="putongxingming">
          <el-input v-model="ruleForm.putongxingming" 
              placeholder="普通姓名" clearable  :readonly="ro.putongxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="普通姓名" prop="putongxingming">
              <el-input v-model="ruleForm.putongxingming" 
                placeholder="普通姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	putongzhanghao : false,
	mima : false,
	putongxingming : false,
	xingbie : false,
	shouji : false,
	youxiang : false,
	zhaopian : false,
	money : false,
      ...
      rules: {
          putongzhanghao: [
                { required: true, message: '普通账号不能为空', trigger: 'blur' },
          ],
          mima: [
                { required: true, message: '密码不能为空', trigger: 'blur' },
          ],
          putongxingming: [
                { required: true, message: '普通姓名不能为空', trigger: 'blur' },
          ],
          xingbie: [
          ],
          shouji: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='putongzhanghao'){
            this.ruleForm.putongzhanghao = obj[o];
	    this.ro.putongzhanghao = true;
            continue;
          }
          if(o=='mima'){
	    ...
	    this.ro.mima = true;
          ...
          if(o=='putongxingming'){
            this.ruleForm.putongxingming = obj[o];
	    this.ro.putongxingming = true;
            continue;
          }
          if(o=='xingbie'){
