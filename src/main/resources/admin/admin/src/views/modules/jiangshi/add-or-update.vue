<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="讲师邮箱" prop="jiangshiyouxiang">
          <el-input v-model="ruleForm.jiangshiyouxiang" 
              placeholder="讲师邮箱" clearable  :readonly="ro.jiangshiyouxiang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="讲师邮箱" prop="jiangshiyouxiang">
              <el-input v-model="ruleForm.jiangshiyouxiang" 
                placeholder="讲师邮箱" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  data() {
	...
	money : false,
      ...
      rules: {
          jiangshigonghao: [
                { required: true, message: '讲师工号不能为空', trigger: 'blur' },
          ],
          mima: [
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.lianxidianhua = true;
          ...
          if(o=='jiangshiyouxiang'){
            this.ruleForm.jiangshiyouxiang = obj[o];
	    this.ro.jiangshiyouxiang = true;
            continue;
          }
          if(o=='money'){
