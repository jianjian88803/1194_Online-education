<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="所属分类" prop="suoshufenlei">
          <el-select v-model="ruleForm.suoshufenlei" placeholder="请选择所属分类">
            <el-option
                v-for="(item,index) in suoshufenleiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="所属分类" prop="suoshufenlei">
	      <el-input v-model="ruleForm.suoshufenlei"
                placeholder="所属分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="所属讲师" prop="suoshujiangshi">
          <el-select v-model="ruleForm.suoshujiangshi" placeholder="请选择所属讲师">
            <el-option
                v-for="(item,index) in suoshujiangshiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="所属讲师" prop="suoshujiangshi">
	      <el-input v-model="ruleForm.suoshujiangshi"
                placeholder="所属讲师" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所属大学" prop="suoshudaxue">
          <el-input v-model="ruleForm.suoshudaxue" 
              placeholder="所属大学" clearable  :readonly="ro.suoshudaxue"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所属大学" prop="suoshudaxue">
              <el-input v-model="ruleForm.suoshudaxue" 
                placeholder="所属大学" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.kechengdagang" label="课程大纲" prop="kechengdagang">
                    <span>{{ruleForm.kechengdagang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kechengmingcheng = true;
          ...
          if(o=='suoshufenlei'){
            this.ruleForm.suoshufenlei = obj[o];
	    this.ro.suoshufenlei = true;
            continue;
          }
          if(o=='keshishu'){
	    ...
	    this.ro.keshishu = true;
          ...
          if(o=='suoshujiangshi'){
            this.ruleForm.suoshujiangshi = obj[o];
	    this.ro.suoshujiangshi = true;
            continue;
          }
	    ...
	    this.ro.kechengfengmian = true;
          ...
          if(o=='suoshudaxue'){
            this.ruleForm.suoshudaxue = obj[o];
	    this.ro.suoshudaxue = true;
            continue;
          }
          if(o=='kechengshipin'){
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              ...
              if (data && data.code === 0) {
                this.suoshufenleiOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
            ...
            this.$http({
              url: `option/jiangshi/jiangshixingming`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.suoshujiangshiOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
	...
	this.ruleForm.kechengxiangqing = this.ruleForm.kechengxiangqing.replace(reg,'../../../springboot8525u/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
